...
public class ListAdapterMore extends BaseAdapter{
	 private final LayoutInflater mInflater;
	  ...
	  public ListAdapterMore(Context context, int titleArrayRes, int urlsArrayRes, int iconsArrayRes) {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    final TextView v;
	    if (convertView == null) {
	      v = (TextView) mInflater.inflate(R.layout.item_more, parent, false);
	      convertView = v;
	    } else {
